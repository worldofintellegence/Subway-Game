...
public class EnemyController : MonoBehaviour {
    ...
    public AnimationClip aniRun, aniJump, aniFall, aniStan, aniAttack, aniIdleStart, aniRunStart;//aniDown, aniLeft, aniRight
    ...
    //xu ly delay di theo nhan vat chinh
    ...
    void Update()
    {
        ...
        //if (!showHide) return;
        transform.position = new Vector3(pointNewEnemy.x, pointNewEnemy.y, transform.position.z);
    ...
    void MoveNearFarFollow()
    {
        ...
        {
            if (playAudio && !Modules.useBonus && !Modules.useTemple) Modules.PlayAudioClipFree(Modules.audioPoNear[Modules.indexLanguage]);
        ...
        {
            if (playAudio && !Modules.useBonus && !Modules.useTemple) Modules.PlayAudioClipFree(Modules.audioPoFar[Modules.indexLanguage]);
