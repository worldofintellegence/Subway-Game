...
public class GetCountryPlayer : MonoBehaviour {
    ...
    public List<ListSpriteFlags> listSpriteFlags = new List<ListSpriteFlags>();
    void Start()
    {
       /* Modules.listSpriteFlags = listSpriteFlags;
...
public class ListSpriteFlags
{
    public string code;
    public Sprite icon;
    public ListSpriteFlags(string codeInput, Sprite iconInput)
    {
        this.code = codeInput;
        this.icon = iconInput;
    }
