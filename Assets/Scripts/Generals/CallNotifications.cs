...
public class CallNotifications : MonoBehaviour {
    ...
    void Start()
    {
        ...
        if(loopRemind)
        LocalNotification.SendRepeatingNotification(1, timeDelay, 86400, titleNotification, contentNotification, new Color32(0xff, 0x44, 0x44, 255), true, true, true, "app_icon");
        else
