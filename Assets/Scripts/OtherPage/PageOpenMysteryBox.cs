...
public class PageOpenMysteryBox : MonoBehaviour {
    ...
    [Header("0 Coin, 1 Key, 2 Skis, 3 HeadStart, 4 ScoreBosster, 5 SpinWheel")]
	...
	public void CallStart () {
        ...
        textBox.text = Mathf.RoundToInt(Modules.totalMysteryBox - 1).ToString();
    ...
    public void TapScene()
    {
        ...
        if (openDone)//neu hoan thanh thi chuyen trang
        {
            ...
            else
            {
                ...
                else if (Modules.nextPageOpenBox == "WheelSpin")
                {
                    ...
                    {
                        if (Modules.nextPageOpenBoxOld == "ShowAchievement")
                        {
                            Modules.containAchievement.SetActive(true);
                            Modules.containAchievement.transform.Find("MainCamera").GetComponent<PageAchievement>().CallStart();
                        }
    ...
    void CreateItemBonus()
    {
        ...
        {
            if (numberRan < 35) indexRan = 0;
            else if (numberRan < 55) indexRan = 1;
            else if (numberRan < 70) indexRan = 2;
            else if (numberRan < 85) indexRan = 3;
            else if (numberRan < 100) indexRan = 4;
            //else if (numberRan < 100) indexRan = 5;
        }
        else
        {
            if (numberRan < 45) indexRan = 0;
            else if (numberRan < 65) indexRan = 1;
            else if (numberRan < 85) indexRan = 2;
            else if (numberRan < 100) indexRan = 4;
            //else if (numberRan < 100) indexRan = 5;
        }
        ...
        //else if (indexRan == 5)//neu la spinWheel
        //{
        //    Modules.totalWheelSpin += valueRan;
        //    textValue = "x";
